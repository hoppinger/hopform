...
<?php else: ?>
  <p class="hopform-form-entry-data"><?php print !empty($elements['#label']) ? ('<strong>' . check_plain($elements['#label'] . ': ') . '</strong>') : ''; ?><?php print !empty($elements['#value']) ? check_plain($elements['#value']) : ''; ?></p>
<?php endif; ?>